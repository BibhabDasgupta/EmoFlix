...
import { Film, Heart, Github, Facebook, Instagram, Twitter } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-[hsl(var(--footer-foreground))] text-opacity-80 text-sm max-w-xs">
              Discover movies that match your mood through our emotion-based recommendation system.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-[hsl(var(--footer-foreground))] text-opacity-80 hover:text-[hsl(var(--footer-foreground))] text-sm transition-colors">
                  Home
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="text-[hsl(var(--footer-foreground))] text-opacity-80 hover:text-[hsl(var(--footer-foreground))] transition-colors">
        ...
        <div className="mt-10 pt-6 border-t border-[hsl(var(--footer-foreground))] border-opacity-20 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link to="#" className="text-xs text-[hsl(var(--footer-foreground))] text-opacity-80 hover:text-[hsl(var(--footer-foreground))] transition-colors">
              Privacy Policy
            </Link>
            <Link to="#" className="text-xs text-[hsl(var(--footer-foreground))] text-opacity-80 hover:text-[hsl(var(--footer-foreground))] transition-colors">
              Terms of Service
